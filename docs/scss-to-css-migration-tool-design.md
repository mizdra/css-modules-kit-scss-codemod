...
| `rgba($c, $a)` / `transparentize` / `opacify`                                      | `rgb(from $c r g b / ...)`                                        | RCS                                                                                                                                                                                                        |
...
- [x] **Step 3: core/parse** — postcss-scss ラッパ。パース失敗の Diagnostic 化。postcss / postcss-scss を exact version で dependencies に追加 ([§5.1](#51-パーサー構成)) (26ac783)
